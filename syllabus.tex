...
& & [or ``Office Hours (DeBlasio)'' on the class team]\\
...
\hspace{2em} Office Hours& TBD & \url{cs2401.deblasiolab.org/f20/officehours/gastelum}\\
& & [or ``Office Hours (Gastelum)'' on the class team]\\
\end{tabular}
...
\hspace{2em} Office Hours& TBD & \url{cs2401.deblasiolab.org/f20/officehours/flores}\\
& & [or ``Office Hours (Flores)'' on the class team]\\

Carlo Alvarado  
 & email: & caalvarado7@miners.utep.edu\\
\hspace{2em} Office Hours& TBD & \url{cs2401.deblasiolab.org/f20/officehours/alvarado}\\
& & [or ``Office Hours (Alvarado)'' on the class team]\\
\end{tabular}
...
\hspace{2em} Office Hours& TBD & \url{cs2401.deblasiolab.org/f20/officehours/berkowitz}\\
& & [or ``Office Hours (Berkowitz)'' on the class team]\\
\end{tabular}
