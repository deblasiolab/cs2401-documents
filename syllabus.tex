...
\item Attended office hours with one of the instructors \textbf{twice} (with a specific question) and submitted all of their labs on time, an extra 100 point lab will be averaged into the lab assignments.
\end{itemize}
